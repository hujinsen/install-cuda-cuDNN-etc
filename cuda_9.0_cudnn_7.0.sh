...
#install cuda-command-line-tools dependency
...
wget http://developer.download.nvidia.com/compute/cuda/repos/ubuntu1604/x86_64/cuda-misc-headers-9-0_9.0.176-1_amd64.deb
sudo dpkg -i cuda-misc-headers-9-0_9.0.176-1_amd64.deb

wget http://developer.download.nvidia.com/compute/cuda/repos/ubuntu1604/x86_64/cuda-core-9-0_9.0.176-1_amd64.deb
sudo dpkg -i cuda-core-9-0_9.0.176-1_amd64.deb

wget http://developer.download.nvidia.com/compute/cuda/repos/ubuntu1604/x86_64/cuda-cudart-9-0_9.0.176-1_amd64.deb
sudo dpkg -i cuda-cudart-9-0_9.0.176-1_amd64.deb

wget http://developer.download.nvidia.com/compute/cuda/repos/ubuntu1604/x86_64/cuda-driver-dev-9-0_9.0.176-1_amd64.deb
sudo dpkg -i cuda-driver-dev-9-0_9.0.176-1_amd64.deb

wget http://developer.download.nvidia.com/compute/cuda/repos/ubuntu1604/x86_64/cuda-cudart-dev-9-0_9.0.176-1_amd64.deb
sudo dpkg -i cuda-cudart-dev-9-0_9.0.176-1_amd64.deb

#install cuda-command-line-tools
wget http://developer.download.nvidia.com/compute/cuda/repos/ubuntu1604/x86_64/cuda-command-line-tools-9-0_9.0.176-1_amd64.deb
